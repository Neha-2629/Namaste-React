...
// Github - username
export const Github_UserName = "Neha-2629";
export const Github_Repository_Name = "food-delivery-app";

// Github API for User
export const Github_API_User = "https://api.github.com/users/";

// Social Media Links
export const Linkedin_Link = "https://www.linkedin.com/in/neha-agrawal-02/";
export const Github_Link = "https://github.com/Neha-2629";
export const Email_Link = "mailto:nehaagrawal2995@gmail.com";
